...
# Primary Token : LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
programStart = time.time()
cl = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT หลัก READY ! ====')
ki = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 1 READY ! ====')
kk = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 2 READY ! ====')
kc = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 3 READY ! ====')
km = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 4 READY ! ====')
k5 = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 5 READY ! ====')
k6 = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 6 READY ! ====')
k7 = LINE("primary",appName='OS\t10.1.1\tIOS OS\t1')
print('==== UNIT 7 READY ! ====')
print ('\n\nALL UNIT READY !')
