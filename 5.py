...
cl = LINE("ERU9iQ42Evce39G4gXye.YjYnbfo+QLQt+3mwiSnY3G.7k3GaL03omXuEdkD7JX6t149OeIk7XLz0MOI4w/zD7L26SlFS9wZS7badjIy+R+1")
print('==== UNIT 1 READY ! ====')
ki = LINE("ER4NXdrMHNrnyGsDsYUa.coBy/muEYbDRJwyVkPfGQG.ErwwUaLZCBO5FjMLRav2L5akqEB5voJtLXLGDSnmo7gqRyqAZQh9M2+W4jA5lSaq")
print('==== UNIT 2 READY ! ====')
kk = LINE("ERWFtHNOgCjwMSEEalS9.XB5ScEEtb/WhKkLcGUEpEq.IbrjMIOffy35DdAt7heuehVyBLKrhEwwjjJW6J/hAq5HZusyDFaa24wjhWwq36DP")
print('==== UNIT 3 READY ! ====')
kc = LINE("ERQqExM92L9spjARFSb2.noeD0ijIwIk9d6Jx/Q9JSG.uDG8LJdUaLfODaTM+czCMz9iDYLMjvOoXgwv5vdGOqTONrbOiuMzYlle+54VgKBu")
print('==== UNIT 4 READY ! ====')
km = LINE("ERUdTqNQ1sMqvEQdAbfc.7G8GikX38FEjnPSUPe22Za.GqAYiSjXdx5VkoTxWoWp6C73hT1QqTRMud5Zx5h3aUmkm70wbdhn1y+pYxH3SBNk")
print('==== UNIT 5 READY ! ====')
print ('\n\nALL UNIT READY !')
